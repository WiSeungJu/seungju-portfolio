          ...
          >
            ...
            <div className="space-y-4 text-white/70 leading-relaxed">
              <p>
                ...
                기획, 콘텐츠 제작, 편집, 업로드, 채널 운영까지 전 과정을
                1인으로 2년 넘게 운영하고 있습니다.
              </p>
              <p>
                전문성 있는 콘텐츠와 알고리즘 최적화를 통해 오가닉 트래픽만으로
                팔로워 1만 명을 확보했고, 브랜드 및 외부 업체와의 협업 캠페인을
                50건 이상 진행했습니다.
              </p>
              <p>
            ...
            {[
              {
                ...
                title: "알고리즘 분석",
                description:
                  "플랫폼별 알고리즘을 분석하고, 노출에 유리한 콘텐츠 포맷과 업로드 타이밍을 설계했습니다. 신규 채널 진출 시에도 동일한 방식으로 빠르게 성과를 확보했습니다.",
              },
              {
                step: "02",
                title: "콘텐츠 최적화",
