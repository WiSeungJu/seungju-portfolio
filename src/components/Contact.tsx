...
const links = [
  {
    label: "Email",
    href: "mailto:wesean1108@gmail.com",
    icon: (
      <svg
        width="20"
        height="20"
        ...
        >
          {links.map((link) => (
            <a
              ...
              className="flex items-center gap-2 px-5 py-3 rounded-xl border border-white/10 bg-white/[0.03] text-white/70 hover:text-white hover:border-accent/25 hover:bg-accent/5 transition-all duration-200"
            >
              {link.icon}
